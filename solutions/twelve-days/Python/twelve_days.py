...
gift = ['twelve Drummers Drumming, ', 'eleven Pipers Piping, ', 'ten Lords-a-Leaping, ', 'nine Ladies Dancing, ', 'eight Maids-a-Milking, ', 'seven Swans-a-Swimming, ', 'six Geese-a-Laying, ', 'five Gold Rings, ', 'four Calling Birds, ', 'three French Hens, ', 'two Turtle Doves, and ', 'a Partridge in a Pear Tree.']

def verse(i):
    header = f"On the {ordinal[i-1]} day of Christmas my true love gave to me: "
    gifts = "".join(gift[-i:])
    return f"{header}{gifts}"
